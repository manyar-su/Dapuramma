import { Clock, Compass, ExternalLink, MapPin, PhoneCall } from 'lucide-react';
import { LOCATION_ADDRESS, LOCATION_NAME, WHATSAPP_URL } from '../data';

export default function LocationSection() {
  const mapUrl =
    'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.555901303867!2d107.56475657476!3d-7.20019629280521!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68bf53c89ccfd3%3A0x6b864195155f9cfb!2sTerminal%20Pangalengan!5e0!3m2!1sid!2sid!4v1710000000000!5m2!1sid!2sid';
  const googleMapsLink = 'https://maps.google.com/?q=Terminal+Pangalengan';

  const handleRouteQuery = () => {
    const text =
      'Halo Dapur Ama Snack, saya sedang menuju ke Terminal Pangalengan. Bisa bantu share patokan lokasi outlet?';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-[#1E1E1E]/70 text-sm sm:text-base font-sans">
            Lokasi Dapur Ama Snack tetap diarahkan ke area Terminal Pangalengan sesuai materi promosi yang Anda kirim.
          </p>
        </div>
        ...
        <div id="location-grid" className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="bg-[#FFF6E5] rounded-[2rem] p-8 border-2 border-[#8B5E34]/15 space-y-6 shadow-md">
              <div className="flex gap-4">
                ...
                <div className="space-y-1">
                  <h3 className="font-display font-black text-lg text-[#8B5E34]">Alamat Lengkap</h3>
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-1">
                  <h3 className="font-display font-black text-lg text-[#8B5E34]">Patokan Outlet</h3>
                  <p className="text-[#1E1E1E]/75 text-xs sm:text-sm font-sans leading-relaxed">
                    Cari area jajanan di sekitar terminal. Halaman ini memakai Terminal Pangalengan sebagai titik lokasi utama.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-1">
                  <h3 className="font-display font-black text-lg text-soft-black">Jam Operasional</h3>
                  <div className="text-[#1E1E1E]/75 text-xs sm:text-sm font-sans space-y-0.5">
                    ...
                    <p className="text-[11px] opacity-75">Konfirmasi admin dianjurkan untuk pre-order atau pembelian jumlah besar.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 h-[350px] sm:h-[450px] rounded-[2.5rem] overflow-hidden border-4 border-[#8B5E34]/15 shadow-2xl relative group">
            <div className="absolute top-4 left-4 z-10 bg-[#1E1E1E]/90 text-white text-[11px] font-mono font-bold px-3 py-1.5 rounded-full border border-white/10 flex items-center gap-1.5">
              ...
              <span>Lokasi {LOCATION_NAME}</span>
            </div>
            ...
            <iframe
              ...
              title={`Google Maps ${LOCATION_NAME}`}
            />
          </div>
        </div>
      </div>
